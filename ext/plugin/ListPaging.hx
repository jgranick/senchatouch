...
@:native ("Ext.plugin.ListPaging")
extern class ListPaging extends Component {
	...
	public function addLoadMoreCmp ():Void;
	public function applyLoadMoreCmp (config:Dynamic):Void;
	public function applyLoadTpl (config:Dynamic):Void;
	public function bindStore (newStore:Dynamic, oldStore:Dynamic):Void;
	public function disableDataViewMask (store:Store):Void;
	public function init (list:Dynamic):Void;
	public function loadNextPage ():Void;
	public function onScrollEnd (scroller:Dynamic, x:Dynamic, y:Dynamic):Void;
	public function onStoreBeforeLoad (store:Dynamic):Void;
	public function onStoreLoad (store:Dynamic):Void;
	public function storeFullyLoaded ():Bool;
	public function updateLoading (isLoading:Dynamic):Void;
