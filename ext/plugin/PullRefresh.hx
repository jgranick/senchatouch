...
@:native ("Ext.plugin.PullRefresh")
extern class PullRefresh extends Component {
	...
	public function applyPullTpl (config:Dynamic):Void;
	public function fetchLatest ():Void;
	public function onLatestFetched (operation:Dynamic):Void;
