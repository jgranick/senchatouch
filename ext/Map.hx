...
extern class Map extends Component {
	...
	//public function update (coordinates:Dynamic):Void;
	...
	public function getUseCurrentLocation ():Dynamic;
	...
	public function setUseCurrentLocation (useCurrentLocation:Dynamic):Void;
