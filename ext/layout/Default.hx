...
extern class Default extends Evented {
	...
	public function doItemDockedChange (item:Dynamic, docked:Dynamic, oldDocked:Dynamic):Void;
	
	public function doItemFloatingChange (item:Dynamic, floating:Dynamic):Void;
	
	public function doItemMove (item:Dynamic, toIndex:Dynamic, fromIndex:Dynamic):Void;
	
	public function doItemRemove (item:Dynamic):Void;
	
	public function getAnimation ():Card;
	
	public function setAnimation (animation:Card):Void;
