...
import ext.layout.Fit;

@:native ("Ext.layout.Card")
extern class Card extends Fit {
	...
	//public function doItemRemove (item:Dynamic, index:Dynamic, destroy:Dynamic):Void;
	...
	public function applyAnimation (animation:Dynamic):Void;
	public function doActiveItemChange (me:Dynamic, newActiveItem:Dynamic, oldActiveItem:Dynamic):Void;
	public function onContainerActiveItemChange (container:Dynamic):Void;
	public function updateAnimation (animation:Dynamic, oldAnimation:Dynamic):Void;
