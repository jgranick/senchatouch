...
extern class View extends Container {
	...
	public function applyLayout (config:Dynamic):Void;
	
	public function beforePop (count:Dynamic):Bool;
	
	public function doPop ():Void;
	...
	public function pop (count:Float):Component;
	
	public function push (view:Dynamic):Component;
	...
	public function updateDefaultBackButtonText (defaultBackButtonText:Dynamic):Void;
	
	public function updateUseTitleForBackButtonText (useTitleForBackButtonText:Dynamic):Void;
