...
extern class Bar extends Toolbar {
	...
	public function applyActiveTab (newActiveTab:Dynamic, oldActiveTab:Dynamic):Void;
	public function doSetActiveTab (newTab:Dynamic, oldTab:Dynamic):Void;
	public function doSetDocked (newDocked:Dynamic):Void;
	public function getActiveTab ():Dynamic;
	public function parseActiveTab (tab:Dynamic):Void;
	public function setActiveTab (activeTab:Dynamic):Void;
