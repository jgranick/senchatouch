...
extern class Panel extends Container {
	...
	//public function applyScrollable ():Void;
	...
	public function applyTabBar (config:Dynamic):Void;
	
	public function doTabChange (tabBar:Dynamic, newTab:Dynamic):Void;
	...
	public function onItemDisabledChange (item:Dynamic, newDisabled:Dynamic):Void;
	...
	public function updateTabBar (newTabBar:Dynamic):Void;
	
	public function updateTabBarPosition (position:Dynamic):Void;
