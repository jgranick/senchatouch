...
@:native ("Ext.direct.RemotingProvider")
extern class RemotingProvider extends JsonProvider {
	...
	public function combineAndSend ():Void;
	public function configureRequest (action:String, method:Dynamic):Void;
	public function createHandler (action:String, method:Dynamic):Dynamic;
	public function getCallData (transaction:Transaction):Dynamic;
	public function getTransaction (options:Dynamic):Transaction;
	public function initAPI ():Void;
	public function onData (options:Dynamic, success:Dynamic, response:Dynamic):Void;
	public function queueTransaction (transaction:Transaction):Void;
	public function runCallback (transaction:Transaction, event:Event):Void;
	public function sendRequest (data:Dynamic):Void;
