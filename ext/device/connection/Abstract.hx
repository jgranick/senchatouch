...
@:native ("Ext.device.connection.Abstract")
extern class Abstract extends Evented {

	//public var CELL_2G:String;
	//public var CELL_3G:String;
	//public var CELL_4G:String;
	//public var ETHERNET:String;
	//public var NONE:String;
	//public var UNKNOWN:String;
	//public var WIFI:String;
	public static var CELL_2G:String;
	public static var CELL_3G:String;
	public static var CELL_4G:String;
	public static var ETHERNET:String;
