...
extern class SegmentedButton extends Container {
	...
	public function applyPressedButtons (newButtons:Dynamic):Void;
	...
	public function getPressed ():Void;
