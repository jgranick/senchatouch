...
@:native ("Ext.app.History")
extern class History extends Base {

	
	public function add (action:Action, silent:Bool):Void;
	...
	public function applyToken (token:Dynamic):Void;
	...
	public function detectStateChange ():Void;
