...
extern class Observable extends Base {
	...
	public function addEvents (o:Dynamic, ?more:):Void;
	public function addListener (eventName:String, handler:Dynamic, ?scope:Dynamic, ?options:Dynamic):Void;
	...
	public function on (eventName:String, handler:Dynamic, ?scope:Dynamic, ?options:Dynamic):Void;
	public function relayEvents (origin:Dynamic, events:Array <String>, prefix:String):Void;
	public function removeListener (eventName:String, handler:Dynamic, ?scope:Dynamic):Void;
	...
	public function un (eventName:String, handler:Dynamic, ?scope:Dynamic):Void;
