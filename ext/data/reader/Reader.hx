...
extern class Reader extends Base {
	...
	public static var metaData:Dynamic;
	...
	public function buildExtractors ():Void;
	public function buildRecordDataExtractor ():Void;
	...
	public function extractData (root:Dynamic):Void;
	...
	public function getAssociatedDataRoot (data:Dynamic, associationName:String):Dynamic;
	...
	public function getRoot (data:Dynamic):Dynamic;
	...
	public function onMetaChange (meta:Dynamic):Void;
	public function read (response:Dynamic):ResultSet;
	public function readAssociated (record:Model, data:Dynamic):String;
