...
extern class Server extends Proxy {
	...
	public function applyEncoding (value:Array <Dynamic>):Dynamic;
	...
	public function getParams (operation:Dynamic):Void;
	
	public function getUrl (request:Request):String;
	
	public function processResponse (success:Bool, operation:Operation, request:Request, response:Dynamic, _callback:Dynamic, scope:Dynamic):Void;
	
	public function setException (operation:Operation, response:Dynamic):Void;
	
	public function setExtraParam (name:String, value:Dynamic):Void;
