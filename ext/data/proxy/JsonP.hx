...
extern class JsonP extends Server {
	...
	public function getAutoAppendParams ():Bool;
	public function getCallbackKey ():String;
	public function getRecordParam ():String;
	public function setAutoAppendParams (autoAppendParams:Bool):Void;
	public function setCallbackKey (callbackKey:String):Void;
	public function setRecordParam (recordParam:String):Void;
