...
import ext.data.NodeStore;

@:native ("Ext.data.TreeStore")
extern class TreeStore extends NodeStore {
	...
	public function fillNode (node:NodeInterface, records:Array <Model>):Void;
	public function getClearOnLoad ():Bool;
	public function getDefaultRootId ():String;
	public function getDefaultRootProperty ():String;
	public function getNodeById (id:Dynamic):NodeInterface;
	public function getNodeParam ():String;
	public function getRoot ():Dynamic;
	public function getRootNode (node:Dynamic):Model;
	public function setClearOnLoad (clearOnLoad:Bool):Void;
	public function setDefaultRootId (defaultRootId:String):Void;
	public function setDefaultRootProperty (defaultRootProperty:String):Void;
	public function setNodeParam (nodeParam:String):Void;
	public function setRoot (root:Dynamic):Void;
	public function setRootNode (node:Model):Model;
