...
extern class NodeStore extends Store {
	...
	public function getRootVisible ():Bool;
	
	public function retrieveChildNodes (parent:Dynamic):Void;
	
	public function setNode (node:Model):Void;
	
	public function setRecursive (recursive:Bool):Void;
	
	public function setRootVisible (rootVisible:Bool):Void;
	
	public function treeSortFn (node1:Dynamic, node2:Dynamic):Void;
