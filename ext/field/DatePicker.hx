...
extern class DatePicker extends Text {
	...
	public function getFormattedValue (format:String):String;
	
	public function getPicker ():Dynamic;
	
	public function onMaskTap ():Void;
	
	public function onPickerChange (picker:Date, value:Dynamic):Void;
	
	public function onPickerHide ():Void;
	
	public function setDestroyPickerOnHide (destroyPickerOnHide:Bool):Void;
	
	public function setPicker (picker:Dynamic):Void;
	
	public function updateDateFormat (newDateFormat:Dynamic, oldDateFormat:Dynamic):Void;
