...
extern class Picker extends Sheet {
	...
	public function applyToolbar (config:Dynamic):Void;
	public function getCancelButton ():Dynamic;
	public function getCard ():Dynamic;
	...
	public function getValue (useDom:Dynamic):Dynamic;
	public function getValues ():Dynamic;
	public function onCancelButtonTap ():Void;
	public function onDoneButtonTap ():Void;
	public function onSlotPick (slot:Dynamic):Void;
	public function setCancelButton (cancelButton:Dynamic):Void;
	public function setCard (activeItem:Dynamic):Void;
	...
	public function updateSlots (newSlots:Dynamic):Void;
	public function updateToolbar (newToolbar:Dynamic, oldToolbar:Dynamic):Void;
